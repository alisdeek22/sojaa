// Background Decorations
    ...
    function checkPassword() {
      if (passwordInput.value.trim() === '20/8S') {
    ...
    // Image Carousel
    const images = [
      'https://i.ibb.co/5XVs7kqD/image.png',
      'https://i.ibb.co/KcB6c8rG/image.png',
      'https://i.ibb.co/dwBHmT4P/image.png',
      'https://i.ibb.co/7xzrwK7z/image.png'
    ];
    let currentSlide = 0;
    ...
    function updateLoveTimer() {
      const startDate = new Date('2019-12-10T00:00:00');
      const now = new Date();
